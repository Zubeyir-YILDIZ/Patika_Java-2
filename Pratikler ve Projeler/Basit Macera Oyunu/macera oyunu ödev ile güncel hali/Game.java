...
public class Game
{
    ...
    public void start()
    {
        ...
        dungen dungen1=new dungen("Maden");
                            ...
                            if(!player1.isDead())
                            {
                                ...
                                if(selectionAction==2)
                                {
                                    ...
                                    if(monster.getHealth()<=0)
                                    {
                                        ...
                                        if(player1.isFood())
                                        {
                                            monster=getMonster(4,false);
                                            System.out.println("Mağaradan içeri giden yolu keşfettin aşağı inmek için 1 çıkmak için 2 tuşla");
                                            key2=input.nextInt();
                                            if(key2==2)
                                                break;
                                            else
                                            {
                                                System.out.println("İçeride bir "+monster.getCharName()+" var");
                                                int selectionAction3=runOrAttack(player1,monster);
                                                if(selectionAction3==2) {
                                                    if (player1.getHealth() < 0)
                                                        break;
                                                    fight(player1, monster);
                                                    if (monster.getHealth() <= 0) {
     ...
     Player getMonster(int selection,boolean wood)
    {
        ...
        snake.setPlayer("npc",dmage,12,0,"Yılan",false);
        if(selection==1)
        {
            if(!wood)
                return bear;
